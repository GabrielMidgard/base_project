<template>
  <div>
    ...
    <p>X2 Enter your email address and password to access admin panel.</p>
    <tab-nav :pills="true" class="nav-fill mb-3" id="pills-tab-1">
      ...
      <tab-nav-items :active="false" id="pills-passport-tab-fill"
                    href="#pills-passport-fill" ariaControls="pills-passport-fill"
                    role="tab" :ariaSelected="true" title="Passport" />
    ...
    <tab-content id="pills-tabContent-1" class="mt-0">
      ...
      <tab-content-item :active="false" id="pills-passport-fill" aria-labelled-by="pills-passport-tab-fill">
          <sign-up1-form formType="passport"></sign-up1-form>
      </tab-content-item>
